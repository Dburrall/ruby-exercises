...
def common_sports
    current_sports = ["Basketball", "Disc Golf"]
...
def lucky_number(7)
    ...
    return "Today's lucky number is #{lucky_number}"
end
...
# hint: use Comparable#between?S

twinty_first_century(year)
year = gets.chomp

year=2001..2100? return true: return false
end
